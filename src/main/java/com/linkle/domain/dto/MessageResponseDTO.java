...
public class MessageResponseDTO {
    ...
    // 팩토리: 공통 변환
    // ----------------------------------------------------------------------
    public static MessageResponseDTO fromEntity(ChatMessage msg) {
        if (msg == null) return null;

        MessageResponseDTO.MessageResponseDTOBuilder b = MessageResponseDTO.builder()
     ...
     */
    public static MessageResponseDTO fromEntity(ChatMessage msg, Integer readCount) {
        MessageResponseDTO base = fromEntity(msg);
     ...
     */
    public static MessageResponseDTO forBroadcast(ChatMessage saved) {
    ...
    // 유틸: 리스트 변환
    // ----------------------------------------------------------------------
    public static List<MessageResponseDTO> fromEntityList(List<ChatMessage> messages) {
    ...
    public static List<MessageResponseDTO> fromEntityList(List<ChatMessage> messages, List<Integer> readCounts) {
        if (messages == null) return null;
